document.addEventListener('DOMContentLoaded', () => {
    ...
    const loginFormHTML = `
        <div class="modal-right auth-form" id="login-form">
            ...
            <button class="google-login-btn" onclick="alert('Google Login di-klik!');">
    ...
    const registerFormHTML = `
        <div class="modal-right auth-form hidden" id="register-form">
            ...
            <button class="google-login-btn" onclick="alert('Google Sign Up di-klik!');">
                <img src="https://upload.wikimedia.org/wikipedia/commons/4/4a/Logo_2013_Google.png" alt="Google Logo">
        ...
        modalContent.innerHTML = `
            <div class="modal-inner-wrapper">
                ...
                <div class="modal-right auth-form" id="profile-form">
                    ...
                    <p style="color:#888; margin-top:0px; margin-bottom: 25px;">Perbarui data diri Anda untuk kemudahan checkout.</p>
    ...
    function setupAuthFormListeners() {
        ...
        if (loginForm) {
            loginForm.querySelector('form').addEventListener('submit', (e) => {
                ...
                alert(`Simulasi: Login berhasil! Selamat datang kembali, ${userData.name}.`);
                authModal.classList.remove('active');
                updateHeaderAuthUI(); 
        ...
        if (registerForm) {
            registerForm.querySelector('form').addEventListener('submit', (e) => {
                ...
                if (name) {
                    ...
                    alert(`Simulasi: Pendaftaran berhasil! Selamat datang, ${userData.name}. Mohon lengkapi data diri Anda.`);
                    authModal.classList.remove('active');
                    updateHeaderAuthUI(); 
                    ...
                    alert('Simulasi: Pendaftaran berhasil! Silakan login.');
                    authModal.classList.remove('active');
                    showLoginForm();
                }
